...
class CartTestMultipleInstancesPestCase extends PHPUnit\Framework\TestCase
{
    /**
...
uses(CartTestMultipleInstancesPestCase::class);

beforeEach(function (): void {
    $events = m::mock('Illuminate\Contracts\Events\Dispatcher');
    $events->shouldReceive('dispatch');
    $this->cart1 = new Cart(new SessionMock(), $events, 'shopping', 'uniquesessionkey123', require __DIR__ . '/helpers/configMock.php');
    $this->cart2 = new Cart(new SessionMock(), $events, 'wishlist', 'uniquesessionkey456', require __DIR__ . '/helpers/configMock.php');
});
...
test('cart multiple instances', function (): void {
