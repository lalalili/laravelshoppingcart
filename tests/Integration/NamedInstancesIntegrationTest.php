...
class NamedInstancesIntegrationTestPestCase extends TestCase
{
    /**
    ...
    {
        $app['config']->set('shopping_cart.instances', ['cart' => ['binding' => 'cart', 'instance_name' => 'cart', 'session_key' => 'cart-session-key'], 'checkout' => ['binding' => 'checkout', 'instance_name' => 'checkout', 'session_key' => 'checkout-session-key']]);
    }
}

uses(NamedInstancesIntegrationTestPestCase::class);

test('provider registers configured named instances', function (): void {
