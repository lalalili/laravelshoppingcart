...
class CartFactorySerializationTestPestCase extends TestCase
{
    /**
     ...
     */
    protected function cartConfig(Cart $cart): array
    {
...
uses(CartFactorySerializationTestPestCase::class);

test('factory does not leak control inputs into cart config', function (): void {
    ...
    $cart = (new CartFactory($this->app))->make(['cart_class' => Cart::class, 'storage' => new stdClass(), 'events' => $this->app['events'], 'instance_name' => 'cart', 'session_key' => 'cart-session-key']);
